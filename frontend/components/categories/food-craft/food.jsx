        ...
        return <section className="main-content">
            ...
            <div style={{ display: "flex" }}>
                <div style={{ margin: "20px auto" }}>
                    <h2 style={{ fontWeight: "lighter" }}>Food & Craft</h2>
                    <h3 style={{ fontWeight: "lighter", color: "darkgray" }}>See how artisans and entrepreneurs are using Kickstarter to break new ground in food, fashion, and crafts.</h3>
                </div>
            </div>

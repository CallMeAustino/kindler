        ...
        return <section className="main-content">
            ...
            <div style={{ display: "flex" }}>
                <div style={{ margin: "20px auto" }}>
                    <h2 style={{ fontWeight: "lighter" }}>Comics & Illustration</h2>
                    <h3 style={{ fontWeight: "lighter", color: "darkgray" }}>Explore fanastical worlds and original characters from Kickstarter's community of comics creators and illustrators.</h3>
                </div>
            </div>

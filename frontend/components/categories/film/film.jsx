        ...
        return <section className="main-content">
            ...
            <div style={{ display: "flex" }}>
                <div style={{ margin: "20px auto" }}>
                    <h2 style={{ fontWeight: "lighter" }}>Film</h2>
                    <h3 style={{ fontWeight: "lighter", color: "darkgray" }}>Join forces with the intrepid filmmakers and festival creators changing the way stories get told on screen.</h3>
                </div>
            </div>

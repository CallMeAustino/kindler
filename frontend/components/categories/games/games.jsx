        ...
        return <section className="main-content">
            ...
            <div style={{ display: "flex" }}>
                <div style={{ margin: "20px auto" }}>
                    <h2 style={{ fontWeight: "lighter" }}>Games</h2>
                    <h3 style={{ fontWeight: "lighter", color: "darkgray" }}>From tabletop adventures to beloved revivals, discover the projects forging the future of gameplay.</h3>
                </div>
            </div>

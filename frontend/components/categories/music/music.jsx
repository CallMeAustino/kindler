        ...
        return <section className="main-content">
            ...
            <div style={{ display: "flex" }}>
                <div style={{ margin: "20px auto" }}>
                    <h2 style={{ fontWeight: "lighter" }}>Music</h2>
                    <h3 style={{ fontWeight: "lighter", color: "darkgray" }}>Discover new albums, performances, and independent venues from creators using Kickstarter to shape the future of sound.</h3>
                </div>
            </div>

        ...
        return <section className="main-content">
            ...
            <div className="flex">
                <a href="https://project-kindler.herokuapp.com/?#/projects/2/6" className="three-five" style={{borderRight:"1px solid lightgray", paddingRight:0}}>
                    ...
                    <img style={{ maxHeight: "85%", maxWidth: "85%", borderBottom: "15px solid #037362"}} src="https://miro.medium.com/max/1072/1*0MFdD6_5keqFvIiEX4nrWw.jpeg"></img>
                ...
                <section className="two-five">
                    ...
                    <a href="https://project-kindler.herokuapp.com/?#/projects/2/4" style={{minHeight:70, borderBottom:"1px solid lightgray"}} className="flex mb-20">
                        <img src="https://target.scene7.com/is/image/Target/GUEST_c21c029c-7fcf-489e-9e85-feedca15982e?wid=488&hei=488&fmt=pjpeg" style={{maxWidth:"300px"}}></img>
                    ...
                    <a href="https://project-kindler.herokuapp.com/?#/projects/2/5" style={{ minHeight:70, borderBottom: "1px solid lightgray"}} className="flex mb-20">
                        <img src="https://ichef.bbci.co.uk/news/1024/cpsprodpb/74E8/production/_112482992__111703877_gettyimages-1128870980.jpg" style={{ maxWidth:"300px", marginBottom:20 }}></img>
                        <div>
                    ...
                    <a href="https://project-kindler.herokuapp.com/?#/projects/1/3" style={{ minHeight:70 }} className="flex mb-20">
                        <img src="https://food.fnr.sndimg.com/content/dam/images/food/fullset/2019/5/15/0/FNK_Korean-Grilled-Beef-Bulgogi-H2_s4x3.jpg.rend.hgtvcom.826.620.suffix/1557961246095.jpeg" style={{ maxWidth:"300px" }}></img>
                        <div>
